...
% dynamics, where an input rpm can be applied to all four actuators, 
%
%    function dz = dynamics_uav(t, z, rpm1, rpm2, rpm3, rpm4)
%
%
% *Input arguments:*
%
...
%% Code
    ...
    rpmControl = [rpm1(t); rpm2(t); rpm3(t); rpm4(t)];
    rpmPrev = [rpm1(t-1); rpm2(t-1); rpm3(t-1); rpm4(t-1)];
